...
replaceitem entity @s slot.hotbar 0 mx:class 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
xp 1l @s[tag=!vivo]
...
execute @s[tag=!vivo] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§§aMiembro nuevo!"}]} 
