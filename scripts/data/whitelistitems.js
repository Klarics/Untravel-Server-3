 ...
 */
const white = ["minecraft:example1", "minecraft:example2", "minecraft:example3"];
export const whitelist = Object.setPrototypeOf(Object.fromEntries(white.map((v) => [v, ""])), null);
