 ...
 */
const iicWhite = ["minecraft:pumpkin_stem", "minecraft:melon_stem", "minecraft:standing_sign", "minecraft:wall_sign", "minecraft:reeds"];
export const iicWhitelist = Object.setPrototypeOf(Object.fromEntries(iicWhite.map((v) => [v, ""])), null);
