...
export function credits(message, args) {
    ...
    sendMsgToPlayer(player, [
        ...
        ` `,
        `§l§b                 Major Contributers For Paradox`,
        `§l§c-----------------------------------------------------`,
