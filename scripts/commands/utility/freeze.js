...
export function freeze(message, args) {
    ...
    if (memberHash !== undefined && memberEncode === memberHash) {
        return sendMsgToPlayer(player, `§r§b-§5§lUntravel§eMx§b-§r You cannot freeze staff members.`);
    }
    ...
    if (member.hasTag("nofreeze")) {
        ...
        sendMsgToPlayer(member, `§r§b-§5§lUntravel§eMx§b-§r You are no longer frozen.`);
