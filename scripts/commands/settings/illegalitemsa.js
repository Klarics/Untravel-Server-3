...
export function illegalitemsA(message, args) {
    ...
    if (illegalItemsABoolean === false) {
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has enabled §6IllegalItemsA§r!`);
        IllegalItemsA();
        return;
    }
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has disabled §4IllegalItemsA§r!`);
        return;
    }
}
