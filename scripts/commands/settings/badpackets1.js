...
export function badpackets1(message, args) {
    ...
    if (badPackets1Boolean === false) {
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has enabled §6Badpackets1§r!`);
        BadPackets1();
        return;
    }
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has disabled §4Badpackets1§r!`);
        return;
    }
}
