...
export function chatranks(message, args) {
    ...
    if (chatRanksBoolean === false) {
        ...
        */
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has enabled §6ChatRanks§r!`);
        return;
    }
        ...
        */
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has disabled §4ChatRanks§r!`);
        return;
    }
}
