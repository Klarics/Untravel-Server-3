...
export function namespoofA(message, args) {
    ...
    if (nameSpoofBoolean === false) {
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has enabled §6NamespoofA§r!`);
        NamespoofA();
        return;
    }
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has disabled §4NamespoofA§r!`);
        return;
    }
}
