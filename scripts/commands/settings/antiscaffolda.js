...
export function antiscaffoldA(message, args) {
    ...
    if (antiScaffoldABoolean === false) {
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has enabled §6AntiScaffoldA§r!`);
        ScaffoldA();
        return;
    }
        ...
        sendMsg("@a[tag=paradoxOpped]", `§r§b-§5§lUntravel§eMx§b-§r ${player.nameTag}§r has disabled §4AntiScaffoldA§r!`);
        return;
    }
}
