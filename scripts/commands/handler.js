...
import { spawn } from "./utility/spawn.js";
import { vault } from "./utility/vault.js";
import { gmc } from "./moderation/gmc.js";
import { ctl } from "./moderation/ctl.js";
...
export function commandHandler(player, message) {
    ...
    if (!(commandName in commandDefinitions)) {
        sendMsgToPlayer(player, `§r§b-§5§lUntravel§eMx§b-§r The command ${config.customcommands.prefix}${commandName} does not exist. Try again!`);
