...
function jesusa(id) {
    ...
    for (let player of World.getPlayers()) {
        ...
        if ((!player.hasTag("vanish") && !player.hasTag("swimming") && !player.hasTag("riding") && !player.hasTag("flying") && BlockAtPlayer1.type.id === "minecraft:water" && BlockAtPlayer0.type.id === "minecraft:water") ||
